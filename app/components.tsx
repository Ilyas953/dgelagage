    ...
    return (
        <footer className=" bg-accent w-full xl:min-h-75 text-white flex flex-col   items-center justify-center gap-16 py-16 px-8 lg:px-24 xl:items-start  ">
            ...
            <div className="flex flex-col gap-16  xl:flex-row justify-center ">
             <Image src={data.logo.image} width={265} height={266} alt={data.logo.alt} className="w-fit h-auto drop-shadow-[4px] drop-shadow-accent/10 rounded-xl" />
...
export function Header() {
    ...
    <div className="flex flex-row gap-4 justify-center items-center">
         <Image src={data.logo.image} width={89} height={79} alt={data.logo.alt} className="w-20 h-auto lg:w-24 drop-shadow-[4px] drop-shadow-accent/10 rounded-xl" />
        <p className={`hidden lg:flex text-2xl text-black font-extrabold   `}>{data.entreprise}</p>
            ...
            <div className="hidden lg:flex flex-row gap-8 text-[16px]  ">
                ...
                <Link href="#description"><div className="flex flex-col gap-1 group transition-all duration-500 ease-in-out">À Propos <span className=" transition-all duration-300 ease-in-out border-accent border-1 w-0 opacity-0 group-hover:w-full group-hover:opacity-100"></span> </div></Link>
                ...
                <Link href="#temoignages"><div className="flex flex-col gap-1 group transition-all duration-500 ease-in-out">Témoignages <span className=" transition-all duration-300 ease-in-out border-accent border-1 w-0 opacity-0 group-hover:w-full group-hover:opacity-100"></span> </div></Link>
        ...
        <button aria-label="Ouvrir le menu" onClick={() => setBurger(true)} className="lg:hidden"> <Icon icon="qlementine-icons:menu-burger-16" className={ `${ !burger ? 'opacity-100': 'opacity-0'}  lg:hidden w-[44px] h-11 text-accent`} /></button>
     ...
     {burger && <div className=" fixed top-0 left-0  inset h-screen z-30 w-screen flex flex-col justify-center items-center px-8 py-8 bg-black/85 text-white">
                <div className=" self-end justify-self-start flex flex-row items-end "><button aria-label="Fermer le menu" onClick={() => setBurger(false)}><Icon icon="akar-icons:cross" className="relative   w-[44px] h-11 text-second " /></button></div>
                ...
                <Link href="#service"><div className="flex flex-col gap-1 group transition-all duration-500 ease-in-out" onClick={()=> setBurger(false)}>Nos Services <span className=" transition-all duration-300 ease-in-out border-violet-500 border-1 w-0 opacity-0 group-hover:w-full group-hover:opacity-100"></span> </div></Link>
            ...
            <div className="relative mt-10 lg:col-start-8 lg:col-span-5 lg:flex lg:justify-center ">
                ...
                <div className="flex flex-row gap-8 py-6 px-8 absolute bottom-0 left-0 right-0 lg:w-[70%] bg-white h-auto drop-shadow-xl drop-shadow-black/25 rounded-[16px] justify-center text-center">
                    <div className="flex flex-col justify-center gap-4">
                        ...
                        <p className="text-[20px]">Projets réalisés</p>
                    </div>
...
export function About() {
    ...
    const proves = [
       ...
       },
       {
        ...
        desc: "Des professionnels passionnés et expérimentés à votre service"
       },
       {
...
export function Service() {
    return (
        ...
        <Section  className="w-full h-fit flex flex-col gap-[48px]  bg-fond2 ">
            ...
            <h2 className="text-[48px] text-black font-extrabold text-center  ">Une gamme complète de prestations</h2>
            <p className="font-semibold text-2xl text-center">De la planification à la réalisation, nous maîtrisons tous les aspects de notre métier</p>
...
export function Temoignage() {
    ...
    return (
        ...
        <div id="temoignages">
            ...
            <p className="font-semibold text-2xl text-center">La satisfaction de nos clients est notre plus belle récompense, découvrez leurs avis sur nos prestations</p>
            <div className="flex flex-col gap-[24px] items-center w-full lg:grid lg:grid-cols-12  lg:col-span-full">
